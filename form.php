...
<body>
    <div class="container">
        ...
        <div class="input-group">
            <input pattern="[A-ZÁÉÍÓÚÑ\s]+" type="text" class="form-control" id="nombre">
        </div>
        <label for="curp">CURP</label>
        <div class="input-group">
            <input id="curp" class="form-control" pattern="[A-Z]{4}[0-9]{6}[A-Z]{6}[0-9]{2}" type="text">
        </div>
        <label>Sexo</label>
        <div class="input-group">
            <div class="radio">
                <label class="radio-inline"><input type="radio" name="genero">Masculino</label>
            </div>
            <div class="radio">
                <label class="radio-inline"><input type="radio" name="genero">Femenino</label>
            </div>
        </div>
        <label for="nacionalidad">Nacionalidad</label>
        <div class="input-group">
            <input type="text" class="form-control" id="nacionalidad" pattern="[A-ZÁÉÍÓÚ]">
        </div>
